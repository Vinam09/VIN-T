...
function SideBar() {
    return (
        <div id="sidebar" className="sm:flex flex-col justify-between bg-secondary absolute top-36 bottom-0 border-4 border-primary
         right-0 py-8 px-8 w-full xm:hidden -translate-x-full transform transition duration-200 ease-in-out">
            <nav className = "flex flex-col justify-between">
                <a href="#" className = "sidenav-link mt-20 text-primary text-2xl cursor-pointer mb-7 hover:text-hovercolor">Home</a>
                <a href="#about" className = "sidenav-link text-primary text-2xl cursor-pointer mb-7 hover:text-hovercolor">About</a>
                <a href="#projects" className = "sidenav-link text-primary text-2xl cursor-pointer mb-7 hover:text-hovercolor">Projects</a>
                <a href="#contact" className = "sidenav-link text-primary text-2xl cursor-pointer mb-7 hover:text-hovercolor">Contact</a>
            </nav>
