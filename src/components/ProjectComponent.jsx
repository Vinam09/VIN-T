    ...
    return (
        <div className="flex md:flex-row sm:flex-col xm:mb-32 sm:mb-20 shadow-2xl">
            ...
            <div className = "xl:w-5/12 md:w-1/2 sm:w-full p-4 flex flex-col justify-between ">
                <div>
                    <a href={hyperlink} target="_blank"><h2 className="text-primary 2xl:text-2xl md:text-xl text-left hover:text-hovercolor">{name}</h2></a>
                ...
                <div>
                    <a href={hyperlink} target="_blank"><img src ={link} className="mt-4 w-6 pb-2 hover:animate-bounce"/></a>
                </div>
            </div>
        </div>
    )
